  ...
  return (
    <div className="bg-stone-950 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        {/* SEO-friendly: Content is always in the DOM */}
        {/* Aesthetic Loader Overlay */}
        {isLoading && (
          <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-stone-950 terminal-loader pointer-events-none">
            <div className="text-xl font-mono-file mb-4 tracking-widest text-white">
              &gt; {loadingText}
