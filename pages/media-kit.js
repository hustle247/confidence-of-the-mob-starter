...
export default function MediaKit() {
    ...
    const assets = {
        ...
        storyEvidence: [
            ...
            { id: 'crj-graphic', label: 'The "C+R=J" Graphic', desc: 'Visual formula for social media', pending: false, url: 'https://drive.google.com/open?id=18f-2S0H4R3uuExJzIa_OcUlolizMKpsf&usp=drive_fs', thumbnail: '/images/media-kit/crj-graphic.webp' },
            { id: 'podcast-trailer', label: 'Podcast Trailer/Teaser', desc: 'Short audio/video clip', pending: false, url: '/images/media-kit/episode-1.mp3', thumbnail: '/images/media-kit/podcast-trailer.webp' },
        ...
        editorialTools: [
            ...
            { id: 'press-release', label: 'Press Release (Text & PDF)', desc: 'Ready for copy-paste', pending: false, url: '/images/media-kit/pr0526.pdf', thumbnail: '/images/media-kit/press-release.webp' },
